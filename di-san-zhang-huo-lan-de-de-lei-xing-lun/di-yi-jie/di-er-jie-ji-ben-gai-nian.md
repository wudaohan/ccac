...
- **适配性**
适配性系指个人类型与环境特性配合适当与否的程度，这是霍兰德理论三个衍生假设中最为重要的一个。
根据霍兰德的假设，适配性高低可以预测个人的职业满意程度、职业稳定性及职业成就。
三种方式计算适配性的程度：六角模式指数、曾史二氏指数、艾钦指数

- **统整性**
统整性包括个人统整性和环境统整性
**个人统整性**系指个人在生涯目标、兴趣、能力各方面的清晰度与稳定度。
**环境统整性**则是指某一类的环境或职业是否有清楚的目标、任务与报酬体系。
